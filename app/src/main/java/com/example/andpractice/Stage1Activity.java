...
public class Stage1Activity extends AppCompatActivity {
    ...
    //クリアチェック
    private int clearPointLine = 100;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //画面の左上のさらに左上にすることでユーザーから見えないようにする
        orange.setX(-80.0f);
        orange.setY(-80.0f);
        pink.setX(-80.0f);
        pink.setY(-80.0f);
    ...
    //全てのBGMを一気に止める方法が調べてもなかったのが今後の課題。
    @Override
    ...
    public void changePos() {
        ...
        /*ここから鳥の動きの制御*/
        //楕円の動きにしたかったけど上手くできず、とりあえず一定の上下範囲で
        //乱高下して楕円のような軌道を再現
        // bird
        birdX -= birdSpeed;
    ...
    public void hitCheck(){
        ...
        Log.d("ClearCheck", "Score: " + score);
        //クリア判定とtimerを止めてintentが正常に行えるようにしている
        if(score >= 100){
            if(timer != null){
                timer.cancel();
                timer = null;
            ...
            startActivity(intent);
            Log.d("stageClearCheck" , "ステージをクリアしました");
